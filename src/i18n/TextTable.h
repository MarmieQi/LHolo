...
inline constexpr std::array<TextEntry, kTextKeyCount> kSimplifiedChineseEntries{{
    ...
    {TextKey::CheckboxAltWheelOffset, "Alt + 滚轮 调整结构位置"},
    {TextKey::HotkeyOpenMenu, "打开投影菜单"},
    {TextKey::HotkeyMoveLeft, "结构左移"},
    {TextKey::HotkeyMoveRight, "结构右移"},
    {TextKey::HotkeyMoveForward, "结构前移"},
    {TextKey::HotkeyMoveBackward, "结构后移"},
    {TextKey::HotkeyMoveUp, "结构上移"},
    {TextKey::HotkeyMoveDown, "结构下移"},
...
inline constexpr std::array<TextEntry, kTextKeyCount> kEnglishEntries{{
    ...
    {TextKey::CheckboxAltWheelOffset, "Alt + wheel to adjust the structure position"},
    {TextKey::HotkeyOpenMenu, "Open menu"},
    {TextKey::HotkeyMoveLeft, "Move left"},
    {TextKey::HotkeyMoveRight, "Move right"},
    {TextKey::HotkeyMoveForward, "Move forward"},
    {TextKey::HotkeyMoveBackward, "Move backward"},
    {TextKey::HotkeyMoveUp, "Move up"},
    {TextKey::HotkeyMoveDown, "Move down"},
